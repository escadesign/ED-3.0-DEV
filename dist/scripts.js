...
---------------------------------------------------*/	
function Grayscale() {
      $(".title-wrapper, .section-image").hover(
        function() {
          $(".section-image").css("filter", "grayscale(100%)");
        },
        function() {
          $(".section-image").css("filter", "unset");
        }
			);
}

/*--------------------------------------------------
Function Cursor Morph
---------------------------------------------------*/	
	
function CursorMorph() {

  $(".ajax-link").click(function() {
    $(".shapeshifter").removeClass("play");
    $(".shapeshifter").addClass("rplay");
  });

  $(
    ".ajax-link, .parallax-element, .link, .title-wrapper, .prev-wrap, .next-wrap, .accordion"
  ).hover(
    function() {
      $(".shapeshifter").removeClass("rplay");
      $(".shapeshifter").addClass("play");
    },
    function() {
      $(".shapeshifter").removeClass("play");
      $(".shapeshifter").addClass("rplay");
