...
function FitQuickScreen() {
    ...
    for (var e = document.documentElement, t = document.body, o = document.querySelectorAll(".thumb-page"), i = document.querySelectorAll(".hover-reveal__img"), n = document.querySelectorAll("#quick-projects li"), l = 0; l < n.length; l++) c(i[l], o[l], n[l]);
    ...
    function c(e, t, o) {
        o.addEventListener("click", function () {
            TweenMax.to("#ball", .2, {
                ...
                top: 0,
                left: 0
            }), $("body").addClass("show-loader"), setTimeout(function () {
                $("body").addClass("load-project-thumb")
            }, 160), $(this).addClass("above"), TweenMax.to(".quick-title, .header-middle", .4, {
                opacity: 0,
                ease: Power2.easeOut
            }), setTimeout(function () {
                d(e, t)
